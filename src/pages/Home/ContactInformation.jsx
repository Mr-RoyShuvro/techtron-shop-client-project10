...
const ContactInformation = () => {
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row gap-14 md:gap-5 max-w-5xl mx-auto py-20">
                <div className="bg-gray-100 hover:bg-gray-300 hover:text-white w-60 md:w-96 mx-auto flex flex-col justify-center items-center">
