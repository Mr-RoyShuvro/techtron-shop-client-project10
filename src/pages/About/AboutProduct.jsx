                ...
                <div className="hero pt-10 ">
                    <div className="hero-content flex-col lg:flex-row">
                        <img
                            ...
                            className="max-w-xs md:max-w-2xl shadow-2xl" />
                        <div className="bg-white md:-translate-x-20 p-5 rounded-lg shadow-xl w-full md:w-2/5 card-container group transform transition-transform duration-300 hover:scale-75 hover:bg-gradient-to-r hover:from-[#834a24] hover:to-[#4b2a0f] z-20">
